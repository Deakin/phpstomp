...
class Stomp
{
    ...
    public function readFrame ()
    {
        ...
        do {
            ...
            /*
             * The following block of code will make reading the socket better
             * By using content-length we can read the exact amount of information in the buffer
             * rather then searching the EOF character - Stomp specification >= 1.1
             */
            if (strpos($data, "\n\n") !== false) {
